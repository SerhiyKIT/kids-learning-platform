...
import com.kids.learning.repository.LessonRepository;
import com.kids.learning.service.dto.LessonDTO;
import com.kids.learning.service.mapper.LessonMapper;
...
class LessonResourceIT {
    ...
    public static Lesson createEntity() {
        return new Lesson().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).difficultyLevel(DEFAULT_DIFFICULTY_LEVEL);
    }
    ...
    public static Lesson createUpdatedEntity() {
        return new Lesson().title(UPDATED_TITLE).content(UPDATED_CONTENT).difficultyLevel(UPDATED_DIFFICULTY_LEVEL);
    }
    ...
    void putExistingLesson() throws Exception {
        ...
        updatedLesson.title(UPDATED_TITLE).content(UPDATED_CONTENT).difficultyLevel(UPDATED_DIFFICULTY_LEVEL);
    ...
    void partialUpdateLessonWithPatch() throws Exception {
        ...
        partialUpdatedLesson.title(UPDATED_TITLE);
    ...
    void fullUpdateLessonWithPatch() throws Exception {
        ...
        partialUpdatedLesson.title(UPDATED_TITLE).content(UPDATED_CONTENT).difficultyLevel(UPDATED_DIFFICULTY_LEVEL);
